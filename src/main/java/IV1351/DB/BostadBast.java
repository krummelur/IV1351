...
public class BostadBäst {
    ...
    public static ArrayList<Table> tables() {
        ...
        Table bostadsrattsgupp = new Table("Bostadsrättsgrupp")
        ...
        Table tvattstuga = new Table("Tvättstuga")
        ...
        .addColumn(new Column("tvättstugeid", false, true,
                new ForeignKey(tvattstuga, tvattstuga.getColumn("tvättstugeid")), "integer"))
        ...
        Table hissBestiktningsForetag = new Table("hissbesiktningsföretag")
        ...
        .addColumn(new Column("h 9issbesiktningsföretag", false, false,
                new ForeignKey(hissBestiktningsForetag, hissBestiktningsForetag.getColumn("organisationsnummer")), "integer"));
        ...
        .addColumn(new Column("bostadsrättsgurppsid", false, false,
                new ForeignKey(bostadsrattsgupp, bostadsrattsgupp.getColumn("bostadsrättsgruppsid")), "integer"));

        Table arsavgift = new Table("Årsavgift")
                .addColumn(new Column("verksamhetsår", false, true, null, "integer"))
                .addColumn(new Column("bostadsrättsgruppsid", false, true, new
                        ForeignKey(bostadsrattsgupp, bostadsrattsgupp.getColumn("bostadsrättsgruppsid")), "integer"))
        ...
        Table agandeskap = new Table("Ägandeskap")
        ...
        Table parkeringskoplats = new Table("Parkeringsköplats")
                .addColumn(new Column("bostadsrättsid", false, true,
                        new ForeignKey(bostadsrätt, bostadsrätt.getColumn("bostadsrättsid")), "integer"))
        ...
        ArrayList<Table> allTables = new ArrayList<>(Arrays.asList(brf, bostadsrattsgupp, hus, cykelRum, tvattstuga, maskin, hiss, hissBestiktningsForetag,
                besiktning, bostadsrätt, arsavgift, person, agandeskap, parkeringskoplats, parkeringsplatstyp, koplatsrad,
                parkeringsarsavgift, parkeringsplats));
